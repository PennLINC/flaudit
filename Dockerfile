...
RUN Rscript -e "install.packages(c('dplyr', 'stringr', 'tidyr', 'ggplot2', 'purrr' 'rmarkdown', 'knitr', 'scales', 'ggrepel', 'wordcloud', 'DT', 'naniar', 'gdata', 'lubridate', 'collapsibleTree', 'ggalluvial', 'networkD3', 'data.table'), repos = 'http://cran.us.r-project.org')"
